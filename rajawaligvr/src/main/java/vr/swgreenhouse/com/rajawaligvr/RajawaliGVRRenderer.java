 ...
 */
public abstract class RajawaliGVRRenderer extends RajawaliRenderer implements GvrView.StereoRenderer {
    ...
    protected void onRender(long ellapsedRealTime, double deltaTime) {
        ...
        this.elapsedRealTime = ellapsedRealTime;
    ...
    public void onSurfaceCreated(EGLConfig eglConfig) {
        super.onRenderSurfaceCreated(eglConfig, new MockGL(), -1, -1);
